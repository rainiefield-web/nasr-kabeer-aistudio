...
// --- TYPES & CONTENT ---
type Language = 'en' | 'ar';
type Page = 'home' | 'technology' | 'sustainability' | 'products';
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className={`hidden md:flex items-center gap-6 lg:gap-10 text-sm font-medium tracking-widest uppercase ${scrolled || currentPage !== 'home' ? 'text-gray-800' : 'text-white'}`}>
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="#contact" onClick={(e) => scrollToSection(e, 'contact')} className={`px-6 py-3 border ${scrolled || currentPage !== 'home' ? 'border-nasr-dark text-nasr-dark hover:bg-nasr-dark hover:text-white' : 'border-white text-white hover:bg-white hover:text-nasr-dark'} transition-all duration-300`}>{t.nav.contact}</a>
            </div>
          </div>
